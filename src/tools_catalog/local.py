...
def build_local_tool_definitions():
    return [
        ...
        tool("list_directory", "Lista archivos y carpetas dentro de una ruta.", DirectoryListInput, list_directory, category="filesystem", tags=("read_only",), capabilities=("filesystem.read",), risk_level=RiskLevel.READ_ONLY, requires_confirmation=False),
        tool("read_text_file", "Lee un archivo de texto UTF-8 con limite de caracteres.", ReadTextFileInput, read_text_file, category="filesystem", tags=("read_only",), capabilities=("filesystem.read",), risk_level=RiskLevel.READ_ONLY, requires_confirmation=False),
        tool("search_files", "Busca archivos dentro de una carpeta usando un patron glob.", SearchFilesInput, search_files, category="filesystem", tags=("read_only",), capabilities=("filesystem.search",), risk_level=RiskLevel.READ_ONLY, requires_confirmation=False, timeout_seconds=120),
        tool("get_clipboard", "Devuelve texto del portapapeles.", EmptyInput, get_clipboard, category="clipboard", tags=("read_only",), risk_level=RiskLevel.READ_ONLY, requires_confirmation=False),
